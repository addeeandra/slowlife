...
.ff-modal { position: fixed; top: 8%; left: 50%; transform: translateX(-50%); width: min(520px, 96vw); background: var(--bg); border: 1px solid var(--border); z-index: 130; padding: 16px; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.35); }
